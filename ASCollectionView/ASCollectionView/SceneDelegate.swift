...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        self.pushNewViewControllerAnimated(animated: false)
    }
    ...
    private func pushNewViewControllerAnimated(animated: Bool) {
        ...
        if SIMULATE_WEB_RESPONSE {
            ...
            vc = ViewController()
            vc.navigationItem.rightBarButtonItem = UIBarButtonItem(title: "Push Another Copy"
                                                                   ,
                                                                   style: .plain,
                                                                   target: self,
    ...
    @objc func pushNewViewController() {
        self.pushNewViewControllerAnimated(animated: true)
    }
}
